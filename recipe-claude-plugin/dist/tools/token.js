 ...
 */
import { searchTokens, getTokenInfo, getTrending, getNewLaunches, getOHLCV, getNewPairs, getPairDetails, advancedSearchTokens, } from "../lib/api.js";
                    ...
                    content: [
                        {
                            ...
                            text: JSON.stringify({
                                ...
                                signal: currentPrice > currentEMA
            ...
            try {
                ...
                return {
                    content: [
                        {
                            type: "text",
                            text: JSON.stringify(volumeData.slice(0, limit).map((token) => ({
                                symbol: token.symbol,
                                name: token.name,
                                address: token.address,
                ...
                return {
                    content: [
                        {
                            type: "text",
                            text: JSON.stringify(sorted.map((pair) => ({
                                symbol: pair.symbol,
                                name: pair.name,
                                address: pair.address,
